...
function DeleteModal({ setShowDeleteModal, handleDeleteCompany }) {
  return (
    <>
      <div className="fixed inset-0 p-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] overflow-auto font-[sans-serif]">
        ...
        <div className="w-full max-w-md bg-white shadow-lg rounded-md p-6 relative">
          <svg
            ...
            className="w-3.5 cursor-pointer shrink-0 fill-gray-700 hover:fill-red-500 float-right"
          ...
          <div className="flex flex-col space-y-2">
            ...
            <button
              type="button"
              className="px-6 py-2.5 rounded-md text-gray-700 text-sm font-semibold border-none outline-none bg-gray-200 hover:bg-gray-300 active:bg-gray-200"
              onClick={() => setShowDeleteModal(false)}
            >
              Cancel
            </button>
